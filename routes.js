...
router.get('/v1/datasets/:dataset/field/:field', datasetWrite, datasetsController.getDatasetField)
...
router.post('/v1/datasets/:dataset/properties/edit', datasetWrite, datasetsController.postEditDatasetProperties)
// items routes
...
router.post('/v1/datasets/:dataset/items/:item/update', itemWrite, itemsController.updateItem)
